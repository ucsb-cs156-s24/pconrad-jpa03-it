  ...
  public static String getLoginHTML() {
    return """
      ...
      <form method="POST" action="/login">
          <input type="hidden" name="state" value="HndC7I5SqEYw-H493OGpKqI1fBimokxSJa-jRqJuO7c=">
          <input type="hidden" name="redirectUri" value="http://localhost:8080/login/oauth2/code/my-oauth-provider">
